...
- [Interruptions and provenance](./interruptions.md) — a real worker crash resumed by a fresh worker, a real sandbox loss, and the injected lost-ack as comparison, proven live by `scripts/prove_interruptions.py` (separate step, not a stage).
