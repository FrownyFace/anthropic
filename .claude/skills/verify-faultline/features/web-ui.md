...
- `web-workspace` the workspace column is resizable (drag handle, collapsible to zero, split remembered), with Files / Diffs / Logs tabs (the raw Timeline tab was removed in v20); Logs rows are virtualized and follow the tail while live.
