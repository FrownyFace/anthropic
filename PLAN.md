...
| Submission artefacts | 🟡 | repo pushed, README/RATIONALE/ARCHITECTURE/PLAN finalised 21:45 EDT, all three apps redeployed; **Video recorded**: [demo and design rationale (6:39)](https://drive.google.com/file/d/1vZ4EWA-VQMLbPj-b91YczKytpCIxH1ZY/view?usp=sharing). **Open for the candidate**: submit via the recruiter's Greenhouse link. Claude Code transcripts exported to `transcripts/` (7 sessions + 17 subagents, 2026-09-13 23:30 UTC, `scripts/export_transcripts.sh`) |
